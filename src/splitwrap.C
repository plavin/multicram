...
_EXTERN_C_ int PMPI_T_pvar_get_index(const char *name, int *pvar_index);
_EXTERN_C_ int MPI_T_pvar_get_index(const char *name, int *pvar_index) { 
    int _wrap_py_return_val = 0;
{
  
  _wrap_py_return_val = PMPI_T_pvar_get_index(name, pvar_index);
}    return _wrap_py_return_val;
}
...
_EXTERN_C_ int PMPI_Compare_and_swap(void *origin_addr, void *compare_addr, void *result_addr, MPI_Datatype datatype, int target_rank, MPI_Aint target_disp, MPI_Win win);
_EXTERN_C_ int MPI_Compare_and_swap(void *origin_addr, void *compare_addr, void *result_addr, MPI_Datatype datatype, int target_rank, MPI_Aint target_disp, MPI_Win win) { 
    int _wrap_py_return_val = 0;
{
...
_EXTERN_C_ int PMPI_T_enum_get_item(MPI_T_enum enumtype, int index, int *value, char *name, int *name_len);
_EXTERN_C_ int MPI_T_enum_get_item(MPI_T_enum enumtype, int index, int *value, char *name, int *name_len) { 
    int _wrap_py_return_val = 0;
{
  
  _wrap_py_return_val = PMPI_T_enum_get_item(enumtype, index, value, name, name_len);
}    return _wrap_py_return_val;
}
...
_EXTERN_C_ int PMPI_T_category_get_index(const char *name, int *category_index);
_EXTERN_C_ int MPI_T_category_get_index(const char *name, int *category_index) { 
    int _wrap_py_return_val = 0;
{
  
  _wrap_py_return_val = PMPI_T_category_get_index(name, category_index);
}    return _wrap_py_return_val;
}
...
_EXTERN_C_ int PMPI_T_cvar_get_info(int cvar_index, char *name, int *name_len, int *verbosity, MPI_Datatype *datatype, MPI_T_enum *enumtype, char *desc, int *desc_len, int *bind, int *scope);
_EXTERN_C_ int MPI_T_cvar_get_info(int cvar_index, char *name, int *name_len, int *verbosity, MPI_Datatype *datatype, MPI_T_enum *enumtype, char *desc, int *desc_len, int *bind, int *scope) { 
    int _wrap_py_return_val = 0;
{
  
  _wrap_py_return_val = PMPI_T_cvar_get_info(cvar_index, name, name_len, verbosity, datatype, enumtype, desc, desc_len, bind, scope);
}    return _wrap_py_return_val;
}
...
_EXTERN_C_ int PMPI_Fetch_and_op(void *origin_addr, void *result_addr, MPI_Datatype datatype, int target_rank, MPI_Aint target_disp, MPI_Op op, MPI_Win win);
_EXTERN_C_ int MPI_Fetch_and_op(void *origin_addr, void *result_addr, MPI_Datatype datatype, int target_rank, MPI_Aint target_disp, MPI_Op op, MPI_Win win) { 
    int _wrap_py_return_val = 0;
{
...
_EXTERN_C_ int PMPI_Raccumulate(void *origin_addr, int origin_count, MPI_Datatype origin_datatype, int target_rank, MPI_Aint target_disp, int target_count, MPI_Datatype target_datatype, MPI_Op op, MPI_Win win, MPI_Request *request);
_EXTERN_C_ int MPI_Raccumulate(void *origin_addr, int origin_count, MPI_Datatype origin_datatype, int target_rank, MPI_Aint target_disp, int target_count, MPI_Datatype target_datatype, MPI_Op op, MPI_Win win, MPI_Request *request) { 
    int _wrap_py_return_val = 0;
{
...
_EXTERN_C_ int PMPI_Win_detach(MPI_Win win, void *base);
_EXTERN_C_ int MPI_Win_detach(MPI_Win win, void *base) { 
    int _wrap_py_return_val = 0;
{
...
_EXTERN_C_ int PMPI_T_pvar_get_info(int pvar_index, char *name, int *name_len, int *verbosity, int *var_class, MPI_Datatype *datatype, MPI_T_enum *enumtype, char *desc, int *desc_len, int *bind, int *readonly, int *continuous, int *atomic);
_EXTERN_C_ int MPI_T_pvar_get_info(int pvar_index, char *name, int *name_len, int *verbosity, int *var_class, MPI_Datatype *datatype, MPI_T_enum *enumtype, char *desc, int *desc_len, int *bind, int *readonly, int *continuous, int *atomic) { 
    int _wrap_py_return_val = 0;
{
  
  _wrap_py_return_val = PMPI_T_pvar_get_info(pvar_index, name, name_len, verbosity, var_class, datatype, enumtype, desc, desc_len, bind, readonly, continuous, atomic);
}    return _wrap_py_return_val;
}
